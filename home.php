  ...
  <?php
    ...
    <div class="sidebar">
      ...
      <div class="feeds-list">
        <a><div class="home selected"><svg xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 390.000000 347.000000" preserveAspectRatio="xMidYMid meet" focusable="false" class="home-icon">
    ...
    <div class="home-content" id="feed">
      <div class="home">
          <div class="camacho-icon">
              <img src="ieti-logo-small.png" alt="ieti-camacho" />
          </div>
          <h1>Bienvenid@ al Foro Camacho</h1>
          <p>Tu lugar para debatir, opinar y estar al día con nuestra comunidad.</p>
